...
`;
var VERSION = /* @__PURE__ */ new Version("21.2.14");
...
var p2 = (t, n) => {
  ...
  if (T) for (var e of T(n)) V3.call(n, e) && D(t, e, n[e]);
  return t;
};
...
function tt(t, n) {
  ...
  let e = {}, o = false, m = {}, i = null, M2 = {}, f = (a) => {
    ...
    let { from: g, active: y2, to: P3 } = m[a] || {};
    return S(t, e.autoHeight, e.autoWidth), s3 == null || s3(h), W(t, g), W(t, y2), t.offsetHeight, P2(t, g), W(t, P3), d == null || d(h), new Promise((b) => {
...
var Scroller = class _Scroller extends BaseComponent {
  ...
  static \u0275cmp = /* @__PURE__ */ \u0275\u0275defineComponent({
    ...
    contentQueries: function Scroller_ContentQueries(rf, ctx, dirIndex) {
      if (rf & 1) {
        \u0275\u0275contentQuery(dirIndex, _c010, 4)(dirIndex, _c12, 4)(dirIndex, _c22, 4)(dirIndex, _c32, 4)(dirIndex, PrimeTemplate, 4);
      }
      if (rf & 2) {
        let _t2;
        \u0275\u0275queryRefresh(_t2 = \u0275\u0275loadQuery()) && (ctx.contentTemplate = _t2.first);
...
function Select_ng_template_9_ng_template_8_ng_template_2_ng_container_0_Template(rf, ctx) {
  ...
  if (rf & 2) {
    ...
    \u0275\u0275property("ngStyle", \u0275\u0275pureFunction1(8, _c011, scrollerOptions_r19.itemSize + "px"))("pBind", ctx_r2.ptm("optionGroup"));
...
function Select_ng_template_9_ng_template_8_li_3_Template(rf, ctx) {
  ...
  if (rf & 2) {
    ...
    \u0275\u0275property("ngStyle", \u0275\u0275pureFunction1(5, _c011, scrollerOptions_r19.itemSize + "px"))("pBind", ctx_r2.ptm("emptyMessage"));
    \u0275\u0275advance();
...
//# sourceMappingURL=chunk-QM5AZJSI.js.map
