...
var Ripple = class _Ripple extends BaseComponent {
  ...
  onMouseDown(event) {
    ...
    if (!Tt(ink) && !Nt(ink)) {
      let d2 = Math.max(C(this.el.nativeElement), L(this.el.nativeElement));
      ink.style.height = d2 + "px";
      ink.style.width = d2 + "px";
    }
    let offset = _(this.el.nativeElement);
    let x2 = event.pageX - offset.left + this.document.body.scrollTop - Nt(ink) / 2;
...
//# sourceMappingURL=chunk-AJPSUZES.js.map
