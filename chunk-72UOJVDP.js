...
function MappingsComponent_Conditional_35_ng_template_1_Template(rf, ctx) {
  if (rf & 1) {
    ...
    \u0275\u0275text(30);
    \u0275\u0275pipe(31, "i18n");
    \u0275\u0275element(32, "p-sortIcon", 43);
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(33, "th", 44);
    \u0275\u0275text(34);
    \u0275\u0275pipe(35, "i18n");
    \u0275\u0275element(36, "p-sortIcon", 45);
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(37, "th", 46);
    \u0275\u0275text(38);
    \u0275\u0275pipe(39, "i18n");
    \u0275\u0275element(40, "p-sortIcon", 47);
    \u0275\u0275elementEnd();
    \u0275\u0275element(41, "th", 48);
    \u0275\u0275elementEnd();
  }
  if (rf & 2) {
    \u0275\u0275advance(4);
    \u0275\u0275textInterpolate1("", \u0275\u0275pipeBind1(5, 9, "table.partner"), " ");
    \u0275\u0275advance(4);
    \u0275\u0275textInterpolate1("", \u0275\u0275pipeBind1(9, 11, "table.eventType"), " ");
    \u0275\u0275advance(4);
    \u0275\u0275textInterpolate1("", \u0275\u0275pipeBind1(13, 13, "table.sourceType"), " ");
    \u0275\u0275advance(4);
    \u0275\u0275textInterpolate1("", \u0275\u0275pipeBind1(17, 15, "table.method"), " ");
    \u0275\u0275advance(4);
    \u0275\u0275textInterpolate1("", \u0275\u0275pipeBind1(21, 17, "table.version"), " ");
    \u0275\u0275advance(4);
    \u0275\u0275textInterpolate1("", \u0275\u0275pipeBind1(25, 19, "table.status"), " ");
    \u0275\u0275advance(6);
    \u0275\u0275textInterpolate1(" ", \u0275\u0275pipeBind1(31, 21, "table.transformations"), " ");
    \u0275\u0275advance(4);
    \u0275\u0275textInterpolate1("", \u0275\u0275pipeBind1(35, 23, "table.published"), " ");
    \u0275\u0275advance(4);
    \u0275\u0275textInterpolate1("", \u0275\u0275pipeBind1(39, 25, "table.by"), " ");
  }
}
function MappingsComponent_Conditional_35_ng_template_2_Conditional_12_Template(rf, ctx) {
  if (rf & 1) {
...
function MappingsComponent_Conditional_35_ng_template_2_Conditional_20_Template(rf, ctx) {
  if (rf & 1) {
...
function MappingsComponent_Conditional_35_ng_template_2_Conditional_21_Template(rf, ctx) {
  if (rf & 1) {
...
function MappingsComponent_Conditional_35_ng_template_2_Template(rf, ctx) {
  if (rf & 1) {
    ...
    \u0275\u0275conditionalCreate(12, MappingsComponent_Conditional_35_ng_template_2_Conditional_12_Template, 2, 4, "span", 52);
    \u0275\u0275elementEnd();
    ...
    \u0275\u0275conditionalCreate(20, MappingsComponent_Conditional_35_ng_template_2_Conditional_20_Template, 2, 7, "span", 55)(21, MappingsComponent_Conditional_35_ng_template_2_Conditional_21_Template, 2, 0, "span", 56);
    \u0275\u0275elementEnd();
    ...
    \u0275\u0275pipe(32, "i18n");
    \u0275\u0275listener("onClick", function MappingsComponent_Conditional_35_ng_template_2_Template_p_button_onClick_31_listener() {
    ...
    \u0275\u0275pipe(34, "i18n");
    \u0275\u0275listener("onClick", function MappingsComponent_Conditional_35_ng_template_2_Template_p_button_onClick_33_listener() {
      const m_r6 = \u0275\u0275restoreView(_r5).$implicit;
      const ctx_r3 = \u0275\u0275nextContext(2);
    ...
    \u0275\u0275listener("onClick", function MappingsComponent_Conditional_35_ng_template_2_Template_p_button_onClick_35_listener() {
      const m_r6 = \u0275\u0275restoreView(_r5).$implicit;
      const ctx_r3 = \u0275\u0275nextContext(2);
    ...
    \u0275\u0275listener("onClick", function MappingsComponent_Conditional_35_ng_template_2_Template_p_button_onClick_36_listener() {
      const m_r6 = \u0275\u0275restoreView(_r5).$implicit;
      const ctx_r3 = \u0275\u0275nextContext(2);
    ...
    \u0275\u0275listener("onClick", function MappingsComponent_Conditional_35_ng_template_2_Template_p_button_onClick_37_listener() {
      const m_r6 = \u0275\u0275restoreView(_r5).$implicit;
      const ctx_r3 = \u0275\u0275nextContext(2);
      return \u0275\u0275resetView(ctx_r3.cloneMapping(m_r6));
    });
    ...
    \u0275\u0275pipe(39, "i18n");
    \u0275\u0275listener("onClick", function MappingsComponent_Conditional_35_ng_template_2_Template_p_button_onClick_38_listener($event) {
      const m_r6 = \u0275\u0275restoreView(_r5).$implicit;
      const ctx_r3 = \u0275\u0275nextContext(2);
    ...
    \u0275\u0275pipe(41, "i18n");
    \u0275\u0275listener("onClick", function MappingsComponent_Conditional_35_ng_template_2_Template_p_button_onClick_40_listener($event) {
      const m_r6 = \u0275\u0275restoreView(_r5).$implicit;
      const ctx_r3 = \u0275\u0275nextContext(2);
...
function MappingsComponent_Conditional_35_ng_template_3_Template(rf, ctx) {
  if (rf & 1) {
...
function MappingsComponent_Conditional_35_Template(rf, ctx) {
  if (rf & 1) {
    const _r3 = \u0275\u0275getCurrentView();
    \u0275\u0275elementStart(0, "p-table", 25);
    \u0275\u0275listener("selectionChange", function MappingsComponent_Conditional_35_Template_p_table_selectionChange_0_listener($event) {
      \u0275\u0275restoreView(_r3);
      const ctx_r3 = \u0275\u0275nextContext();
      return \u0275\u0275resetView(ctx_r3.selectedMappings.set($event));
    });
    \u0275\u0275template(1, MappingsComponent_Conditional_35_ng_template_1_Template, 42, 27, "ng-template", 26)(2, MappingsComponent_Conditional_35_ng_template_2_Template, 42, 29, "ng-template", 27)(3, MappingsComponent_Conditional_35_ng_template_3_Template, 4, 3, "ng-template", 28);
    \u0275\u0275elementEnd();
  }
  if (rf & 2) {
    const ctx_r3 = \u0275\u0275nextContext();
...
function MappingsComponent_Conditional_37_For_67_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275elementStart(0, "li");
    \u0275\u0275element(1, "i", 82);
    \u0275\u0275text(2);
...
function MappingsComponent_Conditional_37_Conditional_71_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275elementStart(0, "p");
...
function MappingsComponent_Conditional_37_Conditional_72_For_4_Template(rf, ctx) {
  if (rf & 1) {
...
function MappingsComponent_Conditional_37_Conditional_72_Conditional_5_Template(rf, ctx) {
  if (rf & 1) {
...
function MappingsComponent_Conditional_37_Conditional_72_Template(rf, ctx) {
  if (rf & 1) {
    const _r9 = \u0275\u0275getCurrentView();
    \u0275\u0275elementStart(0, "div", 83)(1, "p-button", 84);
    \u0275\u0275listener("onClick", function MappingsComponent_Conditional_37_Conditional_72_Template_p_button_onClick_1_listener() {
      \u0275\u0275restoreView(_r9);
      const ctx_r3 = \u0275\u0275nextContext(2);
    ...
    \u0275\u0275repeaterCreate(3, MappingsComponent_Conditional_37_Conditional_72_For_4_Template, 7, 6, "div", 86, _forTrack0);
    \u0275\u0275elementEnd();
    \u0275\u0275conditionalCreate(5, MappingsComponent_Conditional_37_Conditional_72_Conditional_5_Template, 3, 3, "pre", 87);
  }
  if (rf & 2) {
    let tmp_6_0;
    const ctx_r3 = \u0275\u0275nextContext(2);
...
function MappingsComponent_Conditional_37_Conditional_76_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275elementStart(0, "p");
...
function MappingsComponent_Conditional_37_Conditional_77_For_2_Template(rf, ctx) {
  if (rf & 1) {
...
function MappingsComponent_Conditional_37_Conditional_77_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275elementStart(0, "div", 76);
    \u0275\u0275repeaterCreate(1, MappingsComponent_Conditional_37_Conditional_77_For_2_Template, 8, 7, "div", 92, _forTrack1);
    \u0275\u0275elementEnd();
  }
  if (rf & 2) {
    const ctx_r3 = \u0275\u0275nextContext(2);
...
function MappingsComponent_Conditional_37_ng_template_82_Template(rf, ctx) {
  if (rf & 1) {
...
function MappingsComponent_Conditional_37_ng_template_83_Template(rf, ctx) {
  if (rf & 1) {
...
function MappingsComponent_Conditional_37_Template(rf, ctx) {
  if (rf & 1) {
    ...
    \u0275\u0275repeaterCreate(66, MappingsComponent_Conditional_37_For_67_Template, 3, 1, "li", null, \u0275\u0275repeaterTrackByIdentity);
    \u0275\u0275elementEnd()();
    \u0275\u0275elementStart(68, "section", 73)(69, "h3");
    \u0275\u0275text(70, "Published Versions");
    \u0275\u0275elementEnd();
    \u0275\u0275conditionalCreate(71, MappingsComponent_Conditional_37_Conditional_71_Template, 2, 0, "p")(72, MappingsComponent_Conditional_37_Conditional_72_Template, 6, 2);
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(73, "section", 73)(74, "h3");
    \u0275\u0275text(75, "Execution history");
    \u0275\u0275elementEnd();
    \u0275\u0275conditionalCreate(76, MappingsComponent_Conditional_37_Conditional_76_Template, 2, 0, "p")(77, MappingsComponent_Conditional_37_Conditional_77_Template, 3, 0, "div", 76);
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(78, "section", 73)(79, "h3");
    \u0275\u0275text(80, "Last 50 executions");
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(81, "p-table", 77);
    \u0275\u0275template(82, MappingsComponent_Conditional_37_ng_template_82_Template, 9, 0, "ng-template", 26)(83, MappingsComponent_Conditional_37_ng_template_83_Template, 10, 5, "ng-template", 27);
    \u0275\u0275elementEnd()();
    \u0275\u0275elementStart(84, "div", 78)(85, "p-button", 79);
    \u0275\u0275pipe(86, "i18n");
    \u0275\u0275listener("onClick", function MappingsComponent_Conditional_37_Template_p_button_onClick_85_listener() {
    ...
    \u0275\u0275pipe(88, "i18n");
    \u0275\u0275listener("onClick", function MappingsComponent_Conditional_37_Template_p_button_onClick_87_listener($event) {
      const m_r13 = \u0275\u0275restoreView(_r7);
      const ctx_r3 = \u0275\u0275nextContext();
    ...
    \u0275\u0275pipe(90, "i18n");
    \u0275\u0275listener("onClick", function MappingsComponent_Conditional_37_Template_p_button_onClick_89_listener($event) {
      const m_r13 = \u0275\u0275restoreView(_r7);
      const ctx_r3 = \u0275\u0275nextContext();
...
function MappingsComponent_For_41_Template(rf, ctx) {
  if (rf & 1) {
    ...
    \u0275\u0275listener("onClick", function MappingsComponent_For_41_Template_p_button_onClick_6_listener() {
...
${rows}`], { type: "text/csv;charset=utf-8" });
  ...
  static \u0275cmp = /* @__PURE__ */ \u0275\u0275defineComponent({ type: _MappingsComponent, selectors: [["app-mappings"]], features: [\u0275\u0275ProvidersFeature([ConfirmationService, MessageService])], decls: 42, vars: 35, consts: [["importFile", ""], [1, "page-header"], [1, "page-title"], [1, "page-subtitle"], [1, "page-actions"], ["type", "file", "accept", "application/json", "hidden", "", 3, "change"], ["label", "Import", "icon", "pi pi-upload", "variant", "outlined", "severity", "secondary", 3, "onClick"], ["label", "Templates", "icon", "pi pi-copy", "variant", "outlined", "severity", "secondary", 3, "onClick"], ["icon", "pi pi-plus", "routerLink", "/wizard", 3, "label"], [1, "table-toolbar"], [1, "toolbar-left"], ["styleClass", "pi pi-search"], ["pInputText", "", 3, "ngModelChange", "ngModel", "placeholder"], ["optionLabel", "label", "optionValue", "value", "styleClass", "status-filter-select", 3, "ngModelChange", "options", "ngModel"], [1, "toolbar-right"], [1, "result-count"], ["icon", "pi pi-send", "variant", "outlined", "severity", "secondary", "size", "small", "pTooltip", "Publish selected", 3, "onClick", "disabled"], ["icon", "pi pi-ban", "variant", "outlined", "severity", "warn", "size", "small", "pTooltip", "Deprecate selected", 3, "onClick", "disabled"], ["icon", "pi pi-download", "variant", "outlined", "severity", "secondary", "size", "small", 3, "onClick", "pTooltip"], ["icon", "pi pi-map", "actionIcon", "pi pi-plus", "routerLink", "/studio", 3, "title", "description", "actionLabel"], ["styleClass", "p-datatable-sm p-datatable-striped", "dataKey", "id", 3, "value", "paginator", "rows", "selection"], ["position", "right", "styleClass", "mapping-detail-drawer", 3, "visibleChange", "visible"], ["header", "Mapping templates", 3, "visibleChange", "visible", "modal"], [1, "template-list"], [1, "template-item"], ["styleClass", "p-datatable-sm p-datatable-striped", "dataKey", "id", 3, "selectionChange", "value", "paginator", "rows", "selection"], ["pTemplate", "header"], ["pTemplate", "body"], ["pTemplate", "emptymessage"], [2, "width", "44px"], ["pSortableColumn", "partner"], ["field", "partner"], ["pSortableColumn", "eventType"], ["field", "eventType"], ["pSortableColumn", "sourceType"], ["field", "sourceType"], ["pSortableColumn", "method"], ["field", "method"], ["pSortableColumn", "version"], ["field", "version"], ["pSortableColumn", "status"], ["field", "status"], ["pSortableColumn", "transformations", 2, "text-align", "right"], ["field", "transformations"], ["pSortableColumn", "createdAt"], ["field", "createdAt"], ["pSortableColumn", "publishedBy"], ["field", "publishedBy"], [2, "width", "160px"], [3, "value"], [1, "event-code"], ["severity", "secondary", 3, "value"], [3, "class"], [1, "version-badge"], [3, "severity", "value"], [1, "health-badge", 3, "healthy", "degraded", "unhealthy"], [1, "health-badge", "untested"], [1, "text-sm", 2, "text-align", "right"], [1, "text-sm", "text-color-secondary"], [1, "row-actions"], ["icon", "pi pi-eye", "variant", "text", "severity", "secondary", "size", "small", 3, "onClick", "pTooltip"], ["icon", "pi pi-objects-column", "variant", "text", "severity", "secondary", "size", "small", 3, "onClick", "pTooltip"], ["icon", "pi pi-download", "variant", "text", "severity", "secondary", "size", "small", "pTooltip", "Export JSON", 3, "onClick"], ["icon", "pi pi-clone", "variant", "text", "severity", "secondary", "size", "small", "pTooltip", "Clone", 3, "onClick"], ["icon", "pi pi-copy", "variant", "text", "severity", "secondary", "size", "small", "pTooltip", "Clone", 3, "onClick"], ["icon", "pi pi-ban", "variant", "text", "severity", "warn", "size", "small", 3, "onClick", "disabled", "pTooltip"], ["icon", "pi pi-trash", "variant", "text", "severity", "danger", "size", "small", 3, "onClick", "pTooltip"], [1, "health-badge"], ["colspan", "12", 1, "empty-cell"], [1, "drawer-header"], [1, "drawer-eyebrow"], [1, "version-chip"], [1, "detail-grid"], [1, "detail-section"], [1, "checksum-code"], [1, "rules-list"], [1, "trend-list"], ["styleClass", "p-datatable-sm", 3, "value"], [1, "drawer-actions"], ["icon", "pi pi-objects-column", "styleClass", "w-full", 3, "onClick", "label"], ["icon", "pi pi-ban", "severity", "warn", "variant", "outlined", "styleClass", "w-full", 3, "onClick", "label", "disabled"], ["icon", "pi pi-trash", "severity", "danger", "variant", "outlined", "styleClass", "w-full", 3, "onClick", "label"], [1, "pi", "pi-check-circle"], [1, "section-actions"], ["label", "Compare latest", "icon", "pi pi-code", "variant", "outlined", "severity", "secondary", "size", "small", 3, "onClick", "disabled"], [1, "versions-list"], [1, "version-item", 3, "deprecated"], [1, "diff-view"], [1, "version-item"], [1, "version-info"], [1, "version-date"], [3, "value", "severity"], [1, "trend-item"], [2, "text-align", "right"], [1, "text-sm"], ["label", "Use", "icon", "pi pi-plus", "size", "small", 3, "onClick"]], template: function MappingsComponent_Template(rf, ctx) {
    if (rf & 1) {
      ...
      \u0275\u0275listener("change", function MappingsComponent_Template_input_change_11_listener($event) {
      ...
      \u0275\u0275listener("onClick", function MappingsComponent_Template_p_button_onClick_13_listener() {
        \u0275\u0275restoreView(_r1);
        const importFile_r2 = \u0275\u0275reference(12);
        return \u0275\u0275resetView(importFile_r2.click());
      });
      \u0275\u0275elementEnd();
      \u0275\u0275elementStart(14, "p-button", 7);
      \u0275\u0275listener("onClick", function MappingsComponent_Template_p_button_onClick_14_listener() {
        return ctx.loadTemplates();
      });
      \u0275\u0275elementEnd();
      \u0275\u0275element(15, "p-button", 8);
      \u0275\u0275pipe(16, "i18n");
      \u0275\u0275elementEnd()();
      \u0275\u0275elementStart(17, "p-card")(18, "div", 9)(19, "div", 10)(20, "p-iconfield");
      \u0275\u0275element(21, "p-inputicon", 11);
      \u0275\u0275elementStart(22, "input", 12);
      \u0275\u0275pipe(23, "i18n");
      \u0275\u0275listener("ngModelChange", function MappingsComponent_Template_input_ngModelChange_22_listener($event) {
      ...
      \u0275\u0275elementEnd();
      \u0275\u0275elementStart(25, "p-select", 13);
      \u0275\u0275listener("ngModelChange", function MappingsComponent_Template_p_select_ngModelChange_25_listener($event) {
      ...
      \u0275\u0275pipe(33, "i18n");
      \u0275\u0275listener("onClick", function MappingsComponent_Template_p_button_onClick_32_listener() {
        return ctx.exportCsv();
      });
      \u0275\u0275elementEnd()()();
      \u0275\u0275conditionalCreate(34, MappingsComponent_Conditional_34_Template, 4, 9, "app-empty-state", 19);
      \u0275\u0275conditionalCreate(35, MappingsComponent_Conditional_35_Template, 4, 4, "p-table", 20);
      \u0275\u0275elementEnd();
      \u0275\u0275elementStart(36, "p-drawer", 21);
      \u0275\u0275twoWayListener("visibleChange", function MappingsComponent_Template_p_drawer_visibleChange_36_listener($event) {
        \u0275\u0275restoreView(_r1);
        \u0275\u0275twoWayBindingSet(ctx.detailVisible, $event) || (ctx.detailVisible = $event);
        return \u0275\u0275resetView($event);
      });
      \u0275\u0275conditionalCreate(37, MappingsComponent_Conditional_37_Template, 91, 59);
      \u0275\u0275elementEnd();
      \u0275\u0275elementStart(38, "p-dialog", 22);
      \u0275\u0275twoWayListener("visibleChange", function MappingsComponent_Template_p_dialog_visibleChange_38_listener($event) {
        \u0275\u0275restoreView(_r1);
        \u0275\u0275twoWayBindingSet(ctx.templateDialogVisible, $event) || (ctx.templateDialogVisible = $event);
        return \u0275\u0275resetView($event);
      });
      \u0275\u0275elementStart(39, "div", 23);
      \u0275\u0275repeaterCreate(40, MappingsComponent_For_41_Template, 7, 2, "article", 24, _forTrack0);
      \u0275\u0275elementEnd()();
    }
    if (rf & 2) {
      let tmp_17_0;
      \u0275\u0275advance(5);
      \u0275\u0275textInterpolate(\u0275\u0275pipeBind1(6, 22, "mappings.title"));
      \u0275\u0275advance(3);
      \u0275\u0275textInterpolate(\u0275\u0275pipeBind1(9, 24, "mappings.subtitle"));
      \u0275\u0275advance(7);
      \u0275\u0275property("label", \u0275\u0275pipeBind1(16, 26, "mappings.newDemo"));
      \u0275\u0275advance(7);
      \u0275\u0275property("ngModel", ctx.search())("placeholder", \u0275\u0275pipeBind1(23, 28, "mappings.searchPlaceholder"));
      \u0275\u0275advance(2);
      ...
      \u0275\u0275advance(3);
      \u0275\u0275textInterpolate2("", ctx.filtered().length, " ", \u0275\u0275pipeBind1(29, 30, "mappings.results"));
      \u0275\u0275advance(2);
      \u0275\u0275property("disabled", ctx.selectedMappings().length === 0);
      \u0275\u0275advance();
      \u0275\u0275property("disabled", ctx.selectedMappings().length === 0);
      \u0275\u0275advance();
      \u0275\u0275property("pTooltip", \u0275\u0275pipeBind1(33, 32, "mappings.export"));
      \u0275\u0275advance(2);
      \u0275\u0275conditional(ctx.mappings().length === 0 ? 34 : -1);
      \u0275\u0275advance();
      \u0275\u0275conditional(ctx.mappings().length > 0 ? 35 : -1);
      \u0275\u0275advance();
      \u0275\u0275twoWayProperty("visible", ctx.detailVisible);
      \u0275\u0275advance();
      \u0275\u0275conditional((tmp_17_0 = ctx.selectedMapping()) ? 37 : -1, tmp_17_0);
      \u0275\u0275advance();
...
//# sourceMappingURL=chunk-72UOJVDP.js.map
