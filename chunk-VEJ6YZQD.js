...
function DashboardComponent_For_15_Conditional_10_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275element(0, "i", 18);
  }
}
function DashboardComponent_For_15_Conditional_11_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275element(0, "i", 19);
  }
}
function DashboardComponent_For_15_Conditional_12_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275element(0, "i", 20);
  }
}
function DashboardComponent_For_15_Template(rf, ctx) {
  if (rf & 1) {
    ...
    \u0275\u0275conditionalCreate(10, DashboardComponent_For_15_Conditional_10_Template, 1, 0, "i", 18);
    \u0275\u0275conditionalCreate(11, DashboardComponent_For_15_Conditional_11_Template, 1, 0, "i", 19);
    \u0275\u0275conditionalCreate(12, DashboardComponent_For_15_Conditional_12_Template, 1, 0, "i", 20);
    \u0275\u0275text(13);
    \u0275\u0275pipe(14, "i18n");
    \u0275\u0275elementEnd()()();
  }
  if (rf & 2) {
    ...
    \u0275\u0275advance(2);
    \u0275\u0275textInterpolate(\u0275\u0275pipeBind1(8, 13, stat_r1.labelKey));
    \u0275\u0275advance(2);
    \u0275\u0275classMap(stat_r1.changeType);
    \u0275\u0275advance();
    \u0275\u0275conditional(stat_r1.changeType === "positive" ? 10 : -1);
    \u0275\u0275advance();
    \u0275\u0275conditional(stat_r1.changeType === "negative" ? 11 : -1);
    \u0275\u0275advance();
    \u0275\u0275conditional(stat_r1.changeType === "neutral" ? 12 : -1);
    \u0275\u0275advance();
    \u0275\u0275textInterpolate1(" ", \u0275\u0275pipeBind1(14, 15, stat_r1.changeKey), " ");
  }
}
function DashboardComponent_ng_template_17_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275elementStart(0, "div", 21)(1, "div")(2, "h2", 22);
    \u0275\u0275text(3);
    \u0275\u0275pipe(4, "i18n");
    \u0275\u0275elementEnd();
  ...
  if (rf & 2) {
    \u0275\u0275advance(3);
    \u0275\u0275textInterpolate(\u0275\u0275pipeBind1(4, 2, "dashboard.topMappingsTitle"));
    \u0275\u0275advance(3);
    \u0275\u0275textInterpolate(\u0275\u0275pipeBind1(7, 4, "dashboard.topMappingsSubtitle"));
  }
}
function DashboardComponent_ng_template_19_Template(rf, ctx) {
  ...
  if (rf & 2) {
    \u0275\u0275advance(2);
    \u0275\u0275textInterpolate(\u0275\u0275pipeBind1(3, 5, "table.mapping"));
    \u0275\u0275advance(3);
    \u0275\u0275textInterpolate(\u0275\u0275pipeBind1(6, 7, "table.eventType"));
    \u0275\u0275advance(3);
    \u0275\u0275textInterpolate(\u0275\u0275pipeBind1(9, 9, "table.calls"));
    \u0275\u0275advance(3);
    \u0275\u0275textInterpolate(\u0275\u0275pipeBind1(12, 11, "table.errors"));
    \u0275\u0275advance(3);
    \u0275\u0275textInterpolate(\u0275\u0275pipeBind1(15, 13, "table.avgLatency"));
  }
}
...
function DashboardComponent_ng_template_26_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275elementStart(0, "tr")(1, "td")(2, "code", 28);
    \u0275\u0275text(3);
    \u0275\u0275elementEnd()();
    \u0275\u0275elementStart(4, "td")(5, "code", 25);
    \u0275\u0275text(6);
...
var DashboardComponent = class _DashboardComponent {
  ...
  static \u0275cmp = /* @__PURE__ */ \u0275\u0275defineComponent({ type: _DashboardComponent, selectors: [["app-dashboard"]], decls: 27, vars: 14, consts: [[1, "page-header"], [1, "page-title"], [1, "page-subtitle"], [1, "page-actions"], ["icon", "pi pi-objects-column", "routerLink", "/studio", 3, "label"], ["icon", "pi pi-chart-line", "variant", "outlined", "severity", "secondary", "routerLink", "/monitoring", 3, "label"], [1, "stats-grid"], [1, "stat-card"], ["styleClass", "mt-4"], ["pTemplate", "header"], ["styleClass", "p-datatable-sm", 3, "value"], ["pTemplate", "body"], ["pTemplate", "emptymessage"], [1, "stat-icon"], [1, "stat-body"], [1, "stat-value"], [1, "stat-label"], [1, "stat-change"], ["aria-hidden", "true", 1, "pi", "pi-arrow-up"], ["aria-hidden", "true", 1, "pi", "pi-arrow-down"], ["aria-hidden", "true", 1, "pi", "pi-minus"], [1, "card-header-row"], [1, "card-title"], [1, "card-subtitle"], [2, "text-align", "right"], [1, "event-code"], ["colspan", "5", 1, "text-color-secondary", "text-sm"], ["icon", "pi pi-arrow-right", "iconPos", "right", "variant", "outlined", "severity", "secondary", "size", "small", "routerLink", "/mappings", 3, "label"], [1, "partner-code"], [1, "version-badge"], [3, "severity", "value"], [1, "text-color-secondary", "text-sm"]], template: function DashboardComponent_Template(rf, ctx) {
    if (rf & 1) {
      ...
      \u0275\u0275repeaterCreate(14, DashboardComponent_For_15_Template, 15, 17, "div", 7, _forTrack0);
      \u0275\u0275elementEnd();
      \u0275\u0275elementStart(16, "p-card", 8);
      \u0275\u0275template(17, DashboardComponent_ng_template_17_Template, 8, 6, "ng-template", 9);
      \u0275\u0275elementStart(18, "p-table", 10);
      \u0275\u0275template(19, DashboardComponent_ng_template_19_Template, 16, 15, "ng-template", 9)(20, DashboardComponent_ng_template_20_Template, 14, 8, "ng-template", 11)(21, DashboardComponent_ng_template_21_Template, 3, 0, "ng-template", 12);
      \u0275\u0275elementEnd()();
    ...
    <div class="stat-card">
      ...
      <div class="stat-body">
        ...
        <div class="stat-change" [class]="stat.changeType">
          @if (stat.changeType === 'positive') { <i class="pi pi-arrow-up" aria-hidden="true"></i> }
          @if (stat.changeType === 'negative') { <i class="pi pi-arrow-down" aria-hidden="true"></i> }
          @if (stat.changeType === 'neutral') { <i class="pi pi-minus" aria-hidden="true"></i> }
          {{ stat.changeKey | i18n }}
        </div>
      </div>
    </div>
...
<p-card styleClass="mt-4">
  <ng-template pTemplate="header">
    <div class="card-header-row">
      <div>
        <h2 class="card-title">{{ 'dashboard.topMappingsTitle' | i18n }}</h2>
        <p class="card-subtitle">{{ 'dashboard.topMappingsSubtitle' | i18n }}</p>
      </div>
    </div>
  </ng-template>
  ...
  <p-table [value]="topMappings()" styleClass="p-datatable-sm">
    <ng-template pTemplate="header">
      <tr>
        <th>{{ 'table.mapping' | i18n }}</th>
        <th>{{ 'table.eventType' | i18n }}</th>
        <th style="text-align:right">{{ 'table.calls' | i18n }}</th>
        <th style="text-align:right">{{ 'table.errors' | i18n }}</th>
        <th style="text-align:right">{{ 'table.avgLatency' | i18n }}</th>
      </tr>
    </ng-template>
...
//# sourceMappingURL=chunk-VEJ6YZQD.js.map
