...
Bu register'daki no-code integration gap'leri kapatıldı. Sıradaki kalite işi, yeni runtime yüzeylerini e2e ortamında Kafka/topic assertion'larıyla kanıtlamak ve manual trigger endpoint'ini zamanlanmış poller job'a genişletmek.
