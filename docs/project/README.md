...
This folder contains core project planning and strategy documents.
...
- **Implementation**: [../implementation/](../implementation/) - How to build
- **Deployment**: [../deployment/](../deployment/) - How to deploy
- **Operations**: [../operations/](../operations/) - How to operate
- **Testing**: [../testing/](../testing/) - How to test
- **Product**: [../product/](../product/) - Product vision
