-- Keep sample/demo connections aligned with the endpoints implemented by canonbridge-mock.
-- This migration fixes already-migrated local databases without changing historical Flyway checksums.
...
INSERT INTO etl_outbound_connections (
    ...
    (
        ...
        'PayFlex Payment Webhook Receiver',
        'SOURCE_PAYLOAD',
        'REST',
        'POST',
    ...
    (
        ...
        'REST',
        'GET',
        'http://canonbridge-mock:8080/ws/fastcargo.wsdl',
        NULL,
        'PRODUCTION',
        7000,
        'HEALTHY',
...
SET url = 'http://canonbridge-mock:8080/api/payments/latest',
    method = 'GET',
    credential_id = '21111111-2222-3333-4444-555555555551'::uuid,
...
SET url = 'http://canonbridge-mock:8080/api/orders/recent',
    method = 'GET',
    credential_id = '21111111-2222-3333-4444-555555555553'::uuid,
    base_url = 'http://canonbridge-mock:8080',
    known_endpoints = '[
...
SET url = 'http://canonbridge-mock:8080/ws/track',
    method = 'POST',
    credential_id = '21111111-2222-3333-4444-555555555552'::uuid,
    base_url = 'http://canonbridge-mock:8080',
    known_endpoints = '[
