...
function SidebarComponent_Conditional_7_For_2_Conditional_7_For_2_Template(rf, ctx) {
  ...
  if (rf & 2) {
    ...
    \u0275\u0275property("routerLink", item_r4.route)("routerLinkActiveOptions", \u0275\u0275pureFunction0(12, _c0));
...
function SidebarComponent_Conditional_7_For_2_Conditional_7_Template(rf, ctx) {
  if (rf & 1) {
    ...
    \u0275\u0275repeaterCreate(1, SidebarComponent_Conditional_7_For_2_Conditional_7_For_2_Template, 8, 13, "a", 18, _forTrack1);
    \u0275\u0275elementEnd();
  }
  if (rf & 2) {
...
function SidebarComponent_Conditional_7_For_2_Template(rf, ctx) {
  if (rf & 1) {
    ...
    \u0275\u0275listener("click", function SidebarComponent_Conditional_7_For_2_Template_div_click_2_listener() {
  ...
  if (rf & 2) {
    ...
    const ctx_r2 = \u0275\u0275nextContext(2);
    \u0275\u0275attribute("aria-label", \u0275\u0275pipeBind1(1, 5, group_r2.labelKey));
    \u0275\u0275advance(3);
    \u0275\u0275classMap(ctx_r2.isSectionCollapsed(group_r2.labelKey) ? "pi pi-chevron-right" : "pi pi-chevron-down");
    \u0275\u0275advance(2);
    \u0275\u0275textInterpolate(\u0275\u0275pipeBind1(6, 7, group_r2.labelKey));
    \u0275\u0275advance(2);
...
function SidebarComponent_Conditional_7_Template(rf, ctx) {
  if (rf & 1) {
    ...
    \u0275\u0275repeaterCreate(1, SidebarComponent_Conditional_7_For_2_Template, 8, 9, "section", 11, _forTrack0);
    \u0275\u0275elementEnd();
...
function SidebarComponent_Conditional_8_For_2_Template(rf, ctx) {
  ...
  if (rf & 2) {
    ...
    const ctx_r2 = \u0275\u0275nextContext(2);
    \u0275\u0275property("routerLink", item_r5.route)("routerLinkActiveOptions", \u0275\u0275pureFunction0(12, _c0))("pTooltip", \u0275\u0275pipeBind1(1, 8, item_r5.labelKey));
...
function SidebarComponent_Conditional_8_Template(rf, ctx) {
  if (rf & 1) {
    ...
    \u0275\u0275repeaterCreate(1, SidebarComponent_Conditional_8_For_2_Template, 5, 13, "a", 22, _forTrack1);
    \u0275\u0275elementEnd();
  }
  if (rf & 2) {
    const ctx_r2 = \u0275\u0275nextContext();
...
var SidebarComponent = class _SidebarComponent {
  ...
  iconNavItems = [...PRIMARY_NAV, ...SECONDARY_NAV];
  isActive(route) {
  ...
  static \u0275cmp = /* @__PURE__ */ \u0275\u0275defineComponent({ type: _SidebarComponent, selectors: [["app-sidebar"]], inputs: { collapsed: "collapsed" }, decls: 9, vars: 5, consts: [["role", "complementary", "aria-label", "Sidebar navigation", 1, "layout-sidebar"], [1, "layout-sidebar-frame"], [1, "layout-sidebar-header"], ["routerLink", "/mappings", "aria-label", "CanonBridge Mapping Studio - Go to home", 1, "layout-sidebar-brand"], ["aria-hidden", "true", 1, "layout-sidebar-logo"], ["alt", "", 1, "layout-sidebar-logo-img", 3, "src"], [1, "layout-sidebar-titles"], ["id", "primary-navigation", "role", "navigation", "aria-label", "Primary navigation", 1, "layout-sidebar-rail"], [1, "layout-sidebar-title"], [1, "layout-sidebar-sub"], ["id", "primary-navigation", "role", "navigation", "aria-label", "Primary navigation", 1, "layout-sidebar-nav"], ["role", "group", 1, "layout-nav-section"], ["role", "contentinfo", 1, "layout-sidebar-footer"], ["aria-hidden", "true", 1, "layout-sidebar-status-dot"], [1, "layout-sidebar-footer-copy"], [1, "layout-nav-section-title", 3, "click"], ["aria-hidden", "true"], ["role", "list", 1, "layout-nav-list"], ["role", "listitem", "routerLinkActive", "layout-nav-item--active", 1, "layout-nav-item", 3, "routerLink", "routerLinkActiveOptions"], ["aria-hidden", "true", 1, "layout-nav-item__icon"], [1, "layout-nav-item__label"], [1, "layout-nav-item__badge"], ["routerLinkActive", "layout-rail-item--active", "tooltipPosition", "right", 1, "layout-rail-item", 3, "routerLink", "routerLinkActiveOptions", "pTooltip"], [1, "layout-rail-item__badge"]], template: function SidebarComponent_Template(rf, ctx) {
    if (rf & 1) {
    ...
    <div class="layout-sidebar-header">
      <a class="layout-sidebar-brand" routerLink="/mappings" aria-label="CanonBridge Mapping Studio - Go to home">
        <span class="layout-sidebar-logo" aria-hidden="true">
          <img
            [src]="theme.darkMode() ? 'img/canonbridgelogowhite.jpeg' : 'img/canonbridgelogoblack.jpeg'"
            alt=""
...
(() => {
  (typeof ngDevMode === "undefined" || ngDevMode) && \u0275setClassDebugInfo(SidebarComponent, { className: "SidebarComponent", filePath: "src/app/layout/sidebar/sidebar.component.ts", lineNumber: 48 });
})();
...
function TopbarComponent_ng_template_2_Template(rf, ctx) {
  ...
  if (rf & 2) {
    const ctx_r1 = \u0275\u0275nextContext();
    \u0275\u0275advance();
    \u0275\u0275property("rounded", true)("text", true)("pTooltip", \u0275\u0275pipeBind1(2, 6, "topbar.toggleSidebar"));
    \u0275\u0275attribute("aria-label", \u0275\u0275pipeBind1(3, 8, "topbar.toggleSidebar"))("aria-expanded", !ctx_r1.collapsed);
    \u0275\u0275advance(4);
    \u0275\u0275property("src", ctx_r1.theme.darkMode() ? "img/canonbridgelogowhite.jpeg" : "img/canonbridgelogoblack.jpeg", \u0275\u0275sanitizeUrl);
  }
}
...
function TopbarComponent_ng_template_3_Template(rf, ctx) {
  if (rf & 1) {
    ...
    \u0275\u0275listener("click", function TopbarComponent_ng_template_3_Template_div_click_13_listener($event) {
      \u0275\u0275restoreView(_r3);
      const userMenu_r4 = \u0275\u0275reference(17);
      return \u0275\u0275resetView(userMenu_r4.toggle($event));
    })("keydown.enter", function TopbarComponent_ng_template_3_Template_div_keydown_enter_13_listener($event) {
      \u0275\u0275restoreView(_r3);
      const userMenu_r4 = \u0275\u0275reference(17);
      return \u0275\u0275resetView(userMenu_r4.toggle($event));
    })("keydown.space", function TopbarComponent_ng_template_3_Template_div_keydown_space_13_listener($event) {
      \u0275\u0275restoreView(_r3);
      const userMenu_r4 = \u0275\u0275reference(17);
      userMenu_r4.toggle($event);
...
var TopbarComponent = class _TopbarComponent {
  ...
  static \u0275cmp = /* @__PURE__ */ \u0275\u0275defineComponent({ type: _TopbarComponent, selectors: [["app-topbar"]], inputs: { collapsed: "collapsed" }, outputs: { toggleSidebar: "toggleSidebar" }, features: [\u0275\u0275ProvidersFeature([])], decls: 4, vars: 0, consts: [["userMenu", ""], ["styleClass", "layout-toolbar border-none border-bottom-1 surface-border border-round-none", "role", "banner"], ["pTemplate", "start"], ["pTemplate", "end"], [1, "flex", "align-items-center", "gap-2"], ["icon", "pi pi-bars", "severity", "secondary", "tooltipPosition", "bottom", 3, "onClick", "rounded", "text", "pTooltip"], [1, "layout-topbar-heading", "hidden", "md:flex", "align-items-center"], ["alt", "CanonBridge", 1, "layout-topbar-logo", 3, "src"], ["id", "page-actions", "role", "toolbar", "aria-label", "Page actions", 1, "flex", "align-items-center", "flex-wrap", "gap-1", "md:gap-2"], ["severity", "warn", "role", "status", "aria-label", "Demo mode active", 3, "value", "rounded"], ["severity", "secondary", "tooltipPosition", "bottom", 3, "onClick", "icon", "rounded", "text", "pTooltip"], [1, "lang-wrap"], ["for", "lang-select", 1, "sr-only"], ["inputId", "lang-select", "optionLabel", "label", "optionValue", "value", "styleClass", "lang-select", 3, "ngModelChange", "options", "ngModel"], ["tabindex", "0", "role", "button", 1, "user-menu-trigger", "flex", "align-items-center", "gap-2", 3, "click", "keydown.enter", "keydown.space"], ["shape", "circle", "styleClass", "layout-avatar", 3, "label"], ["aria-hidden", "true", 1, "pi", "pi-chevron-down", "text-xs", "text-color-secondary", "hidden", "lg:inline"], [3, "onShow", "onHide", "model", "popup"]], template: function TopbarComponent_Template(rf, ctx) {
    if (rf & 1) {
      \u0275\u0275element(0, "p-toast");
      \u0275\u0275elementStart(1, "p-toolbar", 1);
      \u0275\u0275template(2, TopbarComponent_ng_template_2_Template, 6, 10, "ng-template", 2)(3, TopbarComponent_ng_template_3_Template, 18, 30, "ng-template", 3);
      \u0275\u0275elementEnd();
    }
...
<p-toolbar styleClass="layout-toolbar border-none border-bottom-1 surface-border border-round-none" role="banner">
  ...
  <ng-template pTemplate="end">
    <div id="page-actions" class="flex align-items-center flex-wrap gap-1 md:gap-2" role="toolbar" aria-label="Page actions">
      ...
      <div class="user-menu-trigger flex align-items-center gap-2" 
           (click)="userMenu.toggle($event)"
           (keydown.enter)="userMenu.toggle($event)"
           (keydown.space)="userMenu.toggle($event); $event.preventDefault()"
           tabindex="0"
           role="button"
...
//# sourceMappingURL=chunk-WXUVYCOV.js.map
