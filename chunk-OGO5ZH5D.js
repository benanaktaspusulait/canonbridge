...
function V2(t, e, o = true) {
  var n, r, i3, s4;
  if (t) {
    let a3 = t.offsetParent ? { width: t.offsetWidth, height: t.offsetHeight } : v(t), l3 = a3.height, d2 = a3.width, f = e.offsetHeight, c3 = e.offsetWidth, u = e.getBoundingClientRect(), g2 = D(), w3 = $(), st2 = y2(), W2, N3, nt2 = "top";
    u.top + f + l3 > st2.height ? (W2 = u.top + g2 - l3, nt2 = "bottom", W2 < 0 && (W2 = g2)) : W2 = f + u.top + g2, u.left + d2 > st2.width ? N3 = Math.max(0, u.left + w3 + c3 - d2) : N3 = u.left + w3, I(t) ? t.style.insetInlineEnd = N3 + "px" : t.style.insetInlineStart = N3 + "px", t.style.top = W2 + "px", t.style.transformOrigin = nt2, o && (t.style.marginTop = nt2 === "bottom" ? `calc(${(r = (n = E2(/-anchor-gutter$/)) == null ? void 0 : n.value) != null ? r : "2px"} * -1)` : (s4 = (i3 = E2(/-anchor-gutter$/)) == null ? void 0 : i3.value) != null ? s4 : "");
  }
}
function T(t, e) {
...
function j(t, e, o = true, n = void 0) {
  var r;
  if (t) {
    let i3 = t.offsetParent ? { width: t.offsetWidth, height: t.offsetHeight } : v(t), s4 = e.offsetHeight, a3 = e.getBoundingClientRect(), l3 = y2(), d2, f, c3 = n != null ? n : "top";
    if (!n && a3.top + s4 + i3.height > l3.height ? (d2 = -1 * i3.height, c3 = "bottom", a3.top + d2 < 0 && (d2 = -1 * a3.top)) : d2 = s4, i3.width > l3.width ? f = a3.left * -1 : a3.left + i3.width > l3.width ? f = (a3.left + i3.width - l3.width) * -1 : f = 0, t.style.top = d2 + "px", t.style.insetInlineStart = f + "px", t.style.transformOrigin = c3, o) {
...
function O(t, e = {}) {
  if (p2(t)) {
    let o = (r, i3) => {
      ...
      return [i3].flat().reduce((d2, f) => {
        if (f != null) {
          let c3 = typeof f;
          if (c3 === "string" || c3 === "number") d2.push(f);
          else if (c3 === "object") {
            let u = Array.isArray(f) ? o(r, f) : Object.entries(f).map(([g2, w3]) => r === "style" && (w3 || w3 === 0) ? `${g2.replace(/([a-z])([A-Z])/g, "$1-$2").toLowerCase()}:${w3}` : w3 ? g2 : void 0);
      ...
      o("style", r).forEach((s4) => {
        let a3 = s4.indexOf(":");
        if (a3 < 0) return;
        let l3 = s4.slice(0, a3).trim(), d2 = s4.slice(a3 + 1).trim();
        l3 && t.style.setProperty(l3, d2);
      });
    };
...
function _t(t, e) {
  let o = getComputedStyle(t).getPropertyValue("borderTopWidth"), n = o ? parseFloat(o) : 0, r = getComputedStyle(t).getPropertyValue("paddingTop"), i3 = r ? parseFloat(r) : 0, s4 = t.getBoundingClientRect(), l3 = e.getBoundingClientRect().top + document.body.scrollTop - (s4.top + document.body.scrollTop) - n - i3, d2 = t.scrollTop, f = t.clientHeight, c3 = L(e);
  l3 < 0 ? t.scrollTop = d2 + l3 : l3 + c3 > f && (t.scrollTop = d2 + l3 - f + c3);
}
function te(t, e = "", o) {
...
function $2(e = {}, t = {}) {
  ...
  return Object.keys(t).forEach((o) => {
    let r = o;
    i2(t[r]) && r in e && i2(e[r]) ? n[r] = $2(e[r], t[r]) : n[r] = t[r];
  }), n;
}
function w(...e) {
  ...
  if (a2(e)) {
    ...
    if (G(a3, k3)) {
      let n = a3.replaceAll(k3, (l3) => {
        let c3 = l3.replace(/{|}/g, "").split(".").filter((m3) => !s4.some((d2) => G(m3, d2)));
...
function le(e, t) {
  ...
  for (let n = i3.length - 1; n >= 0; n--) {
    let [l3, o] = i3[n], c3 = e.slice(l3 + 3, o), m3 = r(c3, t), d2 = t(...m3);
...
function de(e, t = {}) {
  ...
  for (; o.length; ) {
    ...
    for (let u in m3) {
      let g2 = m3[u], f = ve(g2), p3 = G(u, a3) ? Q2(d2) : Q2(d2, re(u));
      if (i2(f)) o.push({ node: f, path: p3 });
      else {
        let y3 = ae2(p3), R3 = Y4(f, p3, s4, [a3]);
        Re(l3, y3, R3);
        let T2 = p3;
...
var b3 = { regex: { rules: { class: { pattern: /^\.([a-zA-Z][\w-]*)$/, resolve(e) {
  ...
  if (s2(a3) && n.transform !== "strict") {
    ...
    d2 = `${et}${tt}`, u = [.../* @__PURE__ */ new Set([...We, ...Ze, ...Je])], g2 = m2(a3.css, { dt: E3 });
  }
  return { primitive: { css: l3, tokens: o }, semantic: { css: c3, tokens: m3 }, global: { css: d2, tokens: u }, style: g2 };
}, getPreset({ name: e = "", preset: t = {}, options: r, params: s4, set: i3, defaults: a3, selector: n }) {
  var f, x2, p3;
  let l3, o, c3;
  if (s2(t) && r.transform !== "strict") {
    let y3 = e.replace("-directive", ""), m3 = t, { colorScheme: R3, extend: T2, css: j2 } = m3, O2 = v2(m3, ["colorScheme", "extend", "css"]), d2 = T2 || {}, { colorScheme: M2 } = d2, z2 = v2(d2, ["colorScheme"]), u = R3 || {}, { dark: V3 } = u, L2 = v2(u, ["dark"]), g2 = M2 || {}, { dark: te3 } = g2, re2 = v2(g2, ["dark"]), K2 = s2(O2) ? this._toVariables({ [y3]: h3(h3({}, O2), z2) }, r) : {}, A = s2(L2) ? this._toVariables({ [y3]: h3(h3({}, L2), re2) }, r) : {}, X2 = s2(V3) ? this._toVariables({ [y3]: h3(h3({}, V3), te3) }, r) : {}, [G2, U2] = [(f = K2.declarations) != null ? f : "", K2.tokens || []], [B, I2] = [(x2 = A.declarations) != null ? x2 : "", A.tokens || []], [H2, W2] = [(p3 = X2.declarations) != null ? p3 : "", X2.tokens || []], q3 = this.transformCSS(y3, `${G2}${B}`, "light", "variable", r, i3, a3, n), Z2 = this.transformCSS(y3, H2, "dark", "variable", r, i3, a3, n);
  ...
  return Object.entries(n || {}).reduce((o, [c3, m3]) => {
    if (i2(m3) && Object.hasOwn(m3, "css")) {
      let d2 = Y3(m3.css), u = `${c3}-variables`;
      o.push(`<style type="text/css" data-primevue-style-id="${u}" ${l3}>${d2}</style>`);
    }
    return o;
  }, []).join("");
}, getStyleSheet({ name: e = "", theme: t = {}, params: r, props: s4 = {}, set: i3, defaults: a3 }) {
  var c3;
  let n = { name: e, theme: t, params: r, set: i3, defaults: a3 }, l3 = (c3 = e.includes("-directive") ? this.getPresetD(n) : this.getPresetC(n)) == null ? void 0 : c3.css, o = Object.entries(s4).reduce((m3, [d2, u]) => m3.push(`${d2}="${u}"`) && m3, []).join(" ");
  ...
  let a3 = function(l3, o = {}, c3 = []) {
    ...
    if (typeof this.value == "string" && k3.test(this.value)) {
      ...
      m3 = ne.test(u.replace(ie2, "0")) ? `calc(${u})` : u;
    }
    ...
    Object.entries(l3).forEach(([m3, d2]) => {
      ...
      i2(d2) ? n(d2, u, g2) : (i3[u] || (i3[u] = { paths: [], computed: (f, x2 = {}, p3 = []) => {
      ...
      } }), i3[u].paths.push({ path: g2, value: d2, scheme: g2.includes("colorScheme.light") ? "light" : g2.includes("colorScheme.dark") ? "dark" : "none", computed: a3, tokens: i3 }));
    });
  };
  return n(e, r, s4), i3;
}, getTokenValue(e, t, r) {
  ...
  return n.length === 1 ? n[0].value : n.reduce((o = {}, c3) => {
    let u = c3, { colorScheme: m3 } = u, d2 = v2(u, ["colorScheme"]);
    return o[m3] = d2, o;
  }, void 0);
  ...
  if (s2(t)) {
    ...
    if (s4 !== "style") {
      ...
      t = r === "dark" ? c3.reduce((m3, { type: d2, selector: u }) => (s2(u) && (m3 += u.includes("[CSS]") ? u.replace("[CSS]", t) : this.getSelectorRule(u, l3, d2, t)), m3), "") : C3(l3 != null ? l3 : ":root,:host", t);
    }
    if (o) {
...
var S2 = { defaults: { variable: { prefix: "p", selector: ":root,:host", excludedKeyRegex: /^(primitive|semantic|components|directives|variables|colorscheme|light|dark|common|root|states|extend|css)$/gi }, options: { prefix: "p", darkModeSelector: "system", cssLayer: false } }, _theme: void 0, _layerNames: /* @__PURE__ */ new Set(), _loadedStyleNames: /* @__PURE__ */ new Set(), _loadingStyles: /* @__PURE__ */ new Set(), _tokens: {}, update(e = {}) {
  let { theme: t } = e;
  t && (this._theme = $3(h3({}, t), { options: h3(h3({}, this.defaults.options), t.options) }), this._tokens = b3.createTokens(this.preset, this.defaults), this.clearLoadedStyleNames());
}, get theme() {
  return this._theme;
}, get preset() {
  var e;
...
//# sourceMappingURL=chunk-OGO5ZH5D.js.map
